  ...
  <!--             NAVBAR             -->
    <nav class="navbar navbar-expand-lg bg-primary fixed-top">
      <div class="container-fluid bg-primary navbar-dark">
        ...
        <!--             SEARCH BAR             -->
        <form class="d-flex my-2 flex-grow-1 nav__form mx-5 d-none d-md-flex" role="search" action="products.php" method="post">
          <input class="form-control rounded-0 rounded-start-pill nav__form--input ms-5 border-light fs-4" type="search" placeholder="Search" aria-label="Search">
